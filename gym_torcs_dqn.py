...
class TorcsEnv:
    ...
    def __init__(self, vision=False, throttle=False, gear_change=False, out_of_bounds_counter_limit=10):
        self.vision = vision
        self.throttle = throttle
        self.gear_change = gear_change
        self.out_of_bounds_counter = 0
        self.out_of_bounds_counter_limit = out_of_bounds_counter_limit
    ...
    def step(self, u):
       #print("Step")
        ...
        if (abs(track.any()) > 1 or abs(trackPos) > 1):
            ...
            if self.out_of_bounds_counter >= self.out_of_bounds_counter_limit:
                print("Send TERM command")
